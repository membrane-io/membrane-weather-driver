...
schema.type('ListItem')
  ...
  .field('main', 'Main')
  .field('wheater', '[WheaterInfo]')
  .field('clouds', 'CloudsInfo')
  .field('wind', 'WindInfo')
  .field('rain', 'RainInfo')
  .field('snow', 'SnowInfo')
  .field('sys', 'Sys')
...
schema.type('RainInfo')
  .field('3h', 'String', 'Rain volume for last 3 hours, mm')

schema.type('SnowInfo')
  .field('3h', 'String', 'Snow volume for last 3 hours, mm')
